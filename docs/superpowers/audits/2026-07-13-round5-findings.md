...
2. **CLASS-T2 "good evidence overridden — repeat-occurrence late placement"** —
   ...
   **Fix-round result:** members split across three mechanisms once
   ...
   to `realignRepeatedStanzaOccurrences` (separate iteration). See the A2/A4
   status cells.
...
| 2 | CLASS-T2 repeat-occurrence late placement overriding good evidence | timing | A2 (#46/#16 fixed; #44 residual), A4 (re-triaged) | high-med |
| 3 | CLASS-T3 degenerate head placement (missing/oversized leading evidence) | timing | A3, A5 | med |
