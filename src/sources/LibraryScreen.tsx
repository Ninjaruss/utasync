  ...
  return (
    <div className="relative h-[100dvh] overflow-hidden bg-cinnabar-950 flex flex-col">
      ...
      <div className="flex items-center justify-between px-4 py-4 shrink-0">
        ...
        <button onClick={onSettings} className="min-h-11 px-3 text-white/40 hover:text-white text-xs touch-manipulation transition-colors duration-150 ease-out">⚙ Settings</button>
      </div>
        ...
        {songs.map((song) => {
          ...
          return (
            <div key={song.id} onClick={() => onOpen(song.id)}
              ...
              <button onClick={(e) => { e.stopPropagation(); setPendingDelete(song) }}
