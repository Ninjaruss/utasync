    ...
    <div ref={rootRef} className="relative shrink-0">
      ...
      {open && (
        <div
          role="dialog"
          aria-label="Lyrics display options"
          className="absolute right-0 top-full mt-2 z-50 w-60 rounded-xl border border-cinnabar-800 bg-cinnabar-900 shadow-xl shadow-black/40 p-3 space-y-3"
        >
          {isJapanese && (
            <section className="space-y-2" aria-label="Reading aids">
              ...
              <button
                ...
                className={[
                  toolbarChipBtn, 'w-full text-left px-3 py-2',
          ...
          {hasTranslation && (
            <section className="space-y-2" aria-label="Translation layout">
              ...
              <div className="space-y-1.5">
                <label className={[
                  'flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg border cursor-pointer touch-manipulation min-h-10',
                  ...
                  <input
                    ...
                    className="accent-cinnabar-accent w-4 h-4"
                  />
                </label>
                <label className={[
                  'flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg border cursor-pointer touch-manipulation min-h-10',
